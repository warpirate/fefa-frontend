...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-soft-pink-100 via-white to-soft-pink-200 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              className="mb-4"
            >
              <h1 className="text-3xl font-script text-primary">Welcome Back</h1>
              <p className="text-dark-gray mt-2">Sign in to your FEFA account</p>
            </motion.div>
          </div>
